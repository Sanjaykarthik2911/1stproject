...
con_string = "mongodb+srv://Sanjaykarthik:Sanjay2001@cluster0.5dgsraq.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('Database_of_SGK')

user_collection = pymongo.collection.Collection(db, 'Collections_of_SGK') #(<database_name>,"<collection_name>")
